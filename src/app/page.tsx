        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
            ...
            <CardHeader className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">Vue</span>
                <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded text-xs">Django</span>
          ...
          <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:scale-105">
            ...
            <CardHeader className="space-y-4">
              ...
              <CardDescription className="text-base leading-relaxed">
                Semi-automated Mario Kart leaderboard tracker using OCR, file monitoring, and Discord 
          ...
          <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border-2 border-dashed border-gray-300">
            ...
            <CardHeader className="space-y-4">
              ...
              <CardDescription className="text-base leading-relaxed">
                Exciting new project in development. Stay tuned!
              </CardDescription>
              <div className="flex flex-wrap gap-2">
